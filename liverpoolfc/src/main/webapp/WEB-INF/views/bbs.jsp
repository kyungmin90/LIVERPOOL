...
<div class="container" style="background-color: white; padding-bottom: 50px; border-radius: 20px;">
<div style="width: 150px; margin: 0px auto;"><br>
  <h2 style="font-weight: bold;">게시판</h2></div><br>
  ...
  <table class="table table-striped" id="table">
    ...
    <tbody id="tb">
    <c:forEach var="vo" items="${bbs.rows }">
      <tr>
      	<td>${vo.BNO}</td>
